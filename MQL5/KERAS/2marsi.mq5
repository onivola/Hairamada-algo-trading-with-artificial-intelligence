...
void OnTick()
  {
      ...
      if(ma_5 >= ma_12 && (ma1_5 <= ma1_12 || ma2_5 <= ma2_12) && pas==false) {
         ...
         BuildDataset(ma_buff5,ma_buff12,rsi_buff5,15);
         
            //BuyPosition();
          
            //nb_pos = nb_pos+1;
          while(1) {
               bool datasave = SaveDataset(ma_buff5,ma_buff12,rsi_buff5);
       ...
       if(ma_5 > ma_12 && (ma1_5 > ma1_12 && ma2_5 > ma2_12) && pas==true && posTotal==0) {
            pas= false;
       }
...
bool BuildDataset(double& ma_buff5[],double& ma_buff12[],double& rsi_buff5[], double size) {
...
bool SaveDataset(double& ma_buff5[],double& ma_buff12[],double& rsi_buff5[]) {
