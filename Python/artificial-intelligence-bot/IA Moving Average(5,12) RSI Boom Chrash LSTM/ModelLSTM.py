...
class ModelLSTM:
    ...
    def Iloc_df(self,dataset_train):
        ...
        #dataset_train.head()
        return training_set
    def fitTransform(self,dataset_train,n,p):
        training_set = dataset_train.iloc[:, n:p].values #open values
        sc = MinMaxScaler(feature_range = (0, 1))
    ...
    def Get_xtrain_ytrain(self,training_set_scaled): 
        X_train = []
        y_train = []
        for i in range(60, len(training_set_scaled)-10): #0---10
