...
df = data.DFdatasetCurrent(SYMBOL,TIMEFRAME,28765)
print(df)
...
model_olymp = Model("olymp.model")
#model = model_olymp.fitModel("olymp.model",100,x_train,y_train,x_test,y_test,0.0001)
model = model_olymp.fitModel("olympm3.model",200,x_train,y_train,x_test,y_test,0.0001)
