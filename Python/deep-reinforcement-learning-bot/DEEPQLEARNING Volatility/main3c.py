...
df1 = DFdataset_1(SYMBOL,TIMEFRAME,2022,5,1,2022,5,9)

df2 = DFdataset_1(SYMBOL,TIMEFRAME,2022,5,9,2022,5,10)
...
gain = 0
last_reward = 0
for i in range(1,(len(df1['open'])-222)):
    print(i)
    if(i==1):
        list_reward1 = []
    ac = []
...
gain = 0
last_reward = 0
for i in range(1,len(df2['open'])-222):
    print(i)
    if(i==1):
        list_reward2 = []
    ac = []
