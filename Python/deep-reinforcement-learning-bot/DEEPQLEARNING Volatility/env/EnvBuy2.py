...
class EnvBuy2(gym.Env):
    ...
    def __init__(self, df):
        ...
        self.observation_space = spaces.Box(
            low=0, high=1, shape=(50, 2), dtype=np.float16)
    ...
    def _next_observation(self):
        ...
        xy = self.dataset.get_obs01(self.df,self.current_step,50,6,self.whole)
    ...
    def step(self, action):
        ...
        info = self.end
        self.end = 0
        if(self.current_step > (len(self.df.loc[:, 'open'].values) - (50+12))):
            #done = True
            print("reward=")
            print(self.reward)
            print("gain=")
