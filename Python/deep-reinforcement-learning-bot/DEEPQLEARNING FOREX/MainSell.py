...
from env.EnvSell import EnvSell
...
df1 = DFdataset_1(SYMBOL,TIMEFRAME,2022,5,1,2022,5,5)

df2 = DFdataset_1(SYMBOL,TIMEFRAME,2022,5,5,2022,5,6)
...
env1 = DummyVecEnv([lambda: EnvSell(df1)])
env2 = DummyVecEnv([lambda: EnvSell(df2)])
